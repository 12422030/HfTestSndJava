...
import cfca.safeguard.api.mps.bean.tx.upstream.Tx200103;
import cfca.safeguard.tx.Attachment;

/**
 * 止付解除
 */
public class Tx200103Test {
    public static void main(String[] args) throws Exception {
        ClientEnvironment.initClientEnvironment("config");
        SGBusiness sgBusiness = new SGBusiness();

        Tx200103 tx200103 = new Tx200103();
        String mode = "01";
        String to = "313163000004";
        String fromTGOrganizationId = "";
        String transSerialNumber = "cfcapolice01_0000000000000100002018050446303412075333";

        tx200103.setTransSerialNumber(transSerialNumber);
        tx200103.setApplicationID("20010120180504200101033");
        tx200103.setCaseNumber("AJ13010020160102000");
        tx200103.setCaseType("01");
        tx200103.setOriginalApplicationID("20010120180504200101022");
        tx200103.setEmergencyLevel("01");
        tx200103.setBankID("02");
        tx200103.setBankName("交通银行");
        tx200103.setAccountType("01");
        tx200103.setAccountName("李婷");
        tx200103.setAccountNumber("6217380000000531_1");
        tx200103.setWithdrawalRemark("测试解除止付");
        tx200103.setApplicationTime("20190222000000");
        tx200103.setApplicationOrgID("010000");
        tx200103.setApplicationOrgName("五局");
        tx200103.setOperatorIDType("01");
        tx200103.setOperatorIDNumber("222303197705328831");
        tx200103.setOperatorName("徐处");
        tx200103.setOperatorPhoneNumber("01061957036");
        tx200103.setInvestigatorIDType("01");
        tx200103.setInvestigatorIDNumber("222303197705328831");
        tx200103.setInvestigatorName("徐处");
        ...
        tx200103.setAttachments(attachmentList);

        try {
            sgBusiness.writeUpstreamXml(tx200103, fromTGOrganizationId, mode, to);
